...
在 Wacom 官方驱动与 OpenTabletDriver 之间快速切换的小工具。
...
4. 双击运行程序。
5. 按设置窗口提示完成首次配置。
6. 之后需要切换驱动时，在系统托盘找到程序图标并左键单击。
7. 由于OTD以非管理员权限启动，可能会导致以管理员权限开启的窗口被高亮时数位板失去响应，请参照[该链接](https://ciallo.work/archives/470)设置您的OpenTabletDriver。
